...
![](https://github.com/iamasteriix/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/iamasteriix/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/iamasteriix/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/iamasteriix/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/iamasteriix/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/iamasteriix/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
Runtimes on the lambda server are recorded below.

|                        | elapsed time (sequential) | elapsed time (parallel) |
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |   7:36.08                 |  0:37.02                  | 
| `pg_normalized_batch`  |   2:35.65                 |  0:22.85                  | 
| `pg_denormalized`      |   0:09.56                 |  0:03.93                  |
