# pagila-hw
[![](https://github.com/ceejay-el/pagila-hw/workflows/tests/badge.svg)](https://github.com/ceejay-el/pagila-hw/actions?query=workflow%3Atests)
...
1. Fork this repo and clone it on the lambda server.
   ...
   ```
   $ git clone https://github.com/ceejay-el/pagila-hw
   $ cd pagila-hw
   $ git submodule init
   $ git submodule update
   ```

1. Modify the `README.md` so that the test case image points to your forked repo.
